...
<body>
    ...
    <main>
      <section class="inner-pages-banner offers-bg">
        <div class="container"><h2>Special Offers</h2> </div>
      </section>
                    ...
                    <div class="col-md-6">
                        <div class="room-details offers">
                            ...
                            <ul class="nav nav-tabs" id="room-Tab2" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab2" data-bs-toggle="tab" data-bs-target="#profile-tab-pane2" type="button" role="tab" aria-controls="profile-tab-pane2" aria-selected="false">Terms & Conditions</button>
                                </li>
                            </ul>
