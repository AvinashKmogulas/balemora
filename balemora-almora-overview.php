    ...
    <main>
        <section class="main-home-banner">
            <video autoplay loop muted class="banner-video">
                <source src="assets/videos/Alomra_Banner_Gallery.MP4" type="video/mp4">
            </video>
            <div class="main-home-banner-content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 offset-md-1"><h2 class="text-center">Welcome to <br>Balemora Almora </h2> </div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center home-overview">
                        ...
                        <p class="mb-3" data-aos="fade-up" data-aos-duration="1200">A wellness sanctuary, Balemora Almora invites you to rise above the everyday and immerse yourself in nature’s quiet embrace. Perched in the serene Himalayan foothills, it offers a soulful blend of Panchakarma rituals, forest bathing, sound healing, and ancestral ceremonies. Amidst whispering pines and panoramic vistas, this retreat is where spiritual seekers and wellness travelers find space to reconnect, reflect and restore their inner harmony. </p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-8 mb-5">
                        <h2 class="main-heading text-center pb-3" data-aos="fade-up" data-aos-duration="1200">Your Luxuriously Authentic Stay</h2>
                        <p class="room-home-description">Step into a haven designed for your well-being, where eco-conscious wooden cottages offer a harmonious blend of comfort, elegance, and sustainability. Surrounded by nature’s calm, each space promises a restful escape devoted to balance, rejuvenation, and quiet luxury. </p>
                    </div>
                    <div class="col-md-6">
                        <!-- <div class="owl-carousel owl-theme room-slider"> -->
                            <div class="room-item">
                                <div class="img-container"><img src="assets/images/rooms/almora_room_1.jpg" alt=""> </div>
                                <div class="content">
                                    <div class="active-show-content">
                                        <div class="room-details">
                                            ...
                                            <div class="details">
                                                <div class="icon"> <img src="assets/icons/window-frame.png" alt=""></div>
                                            ...
                                            <div class="details">
                                                ...
                                                <div class="text">3 GUEST </div>
                                            </div>
                                        </div>
                                        <h3>Heritage Family Cottage </h3>
                                        <a href="balemora-almora-living.html">Explore <span class="arrow-icon">
                        ...
                        <div class="home-offer-slider owl-carousel owl-theme">
                            <div class="item">
                                ...
                                <div class="content">
                                    ...
                                    <p>Extend your getaway and enjoy special discounts, premium comforts, and personalized services. Perfect for workcations or leisure stays. </p>
                                    <a href="balemora-almora-special-offers.html" data-aos="fade-up" data-aos-duration="1200">Explore More <span class="arrow-icon"> <img src="assets/icons/black-arrow.png" alt=""></span> </a>
                                </div>
                            </div>                            
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row home-gallery">
                    <div class="owl-carousel owl-theme home-gallery-slider">
                        ...
                        <div class="item">
                            <a href="assets/images/Almora_Gallery/6.jpg" data-lightbox="image-1" data-title="My caption">
                                <img src="assets/images/Almora_Gallery/6.jpg" alt="" class="w-100 horizontal-border">
                            </a>
                        </div>
                        <div class="item">
                            <a href="assets/images/Almora_Gallery/7.jpg" data-lightbox="image-1" data-title="My caption">
                                <img src="assets/images/Almora_Gallery/7.jpg" alt="" class="w-100 horizontal-border">
                            </a>
                        </div>
                        <div class="item">
                            <a href="assets/images/Almora_Gallery/8.jpg" data-lightbox="image-1" data-title="My caption">
                                <img src="assets/images/Almora_Gallery/8.jpg" alt="" class="w-100 horizontal-border">
                            </a>
                        </div>
