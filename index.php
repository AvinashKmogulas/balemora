            ...
            <div class="row">
                <div class="col-md-12 pb-5 text-center home-overview">
                    <h3 class="main-heading" data-aos="fade-up" data-aos-duration="1200">TWO DESTINATIONS. ONE
                        PHILOSOPHY. </h3>
                    <p class="mb-3" data-aos="fade-up" data-aos-duration="1200">Rooted in Ayurveda and slow living, two
                        destinations, each with its own soul. From the grounded elegance of Lucknow to the elevated
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="destination-content" data-aos="fade-up" data-aos-duration="1200">
                        ...
                        <a href="balemora-lucknow-overview.php">Explore <span class="arrow-icon"><img
                ...
                <div class="col-md-6">
                    ...
                    <div class="destination-content" data-aos="fade-up" data-aos-duration="1200">
                        ...
                        <a href="balemora-almora-overview.php">Explore <span class="arrow-icon"><img
                                    src="assets/icons/black-arrow.png" alt=""></span></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="content">
                                ...
                                <p>Discover the sacred city of Lord Ram, where devotion and history come alive.
                                    ...
                                    the Sarayu River.</p>
                                <a href="special-offers.php" data-aos="fade-up" data-aos-duration="1200">Explore More
                                    <span class="arrow-icon"><img src="assets/icons/black-arrow.png" alt=""></span> </a>
                            </div>
                        </div>
