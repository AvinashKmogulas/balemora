    ...
    <ul class="navbar-nav">
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li>
                    <p>Lucknow</p>
                    <a class="dropdown-item" href="balemora-lucknow-overview.php"><i
                            class="fa-solid fa-chevron-right"></i> Balemora NH27, Lucknow</a>
                </li>
                <li>
                    <p>Almora</p>
                    <a class="dropdown-item" href="balemora-almora-overview.php"><i
                            class="fa-solid fa-chevron-right"></i> Balemora, Almora</a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item"><a href="special-offers.php" class="nav-link">Special Offers</a> </li>
