            ...
            <div class="row ">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Learn to prepare healing meals aligned with your dosha using traditional
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            A soothing oil flow over the third eye each evening to calm the mind,
                                            aid
                ...
                <div class="col-md-6">
                    <div class="well_img_box">
                        <img src="assets/wellness/Ayurveda-Tridosha.jpg" alt="" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding wellness-section">
        <div class="container">
            <div class="row ">
                <div class="col-md-6">
                    <div class="well_img_box">
                        <img src="assets/wellness/Ayurveda-soul.jpg" alt="" class="w-100 object-fit-cover">
                    </div>
                </div>
                <div class="col-md-6">
                            ...
                            <div class="accordion" id="accordionHealing">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseEight" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            Begin each day in noble silence with breath-led meditations to ground,
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTen" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionHealing">
                                        <div class="accordion-body">
                                            Conscious breath practices followed by yogic sleep to release tension
                                            and
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseEleven" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionHealing">
                                        <div class="accordion-body">
                                            Gentle Ayurvedic energy point stimulation to open subtle channels and
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThirteen" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionHealing">
                                        <div class="accordion-body">
                                            Mindful walking meditations in nature to enhance presence, elevate mood,
                                            and
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFourteen" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionHealing">
                                        <div class="accordion-body">
                                            Tools and structured practices to disconnect from screens and reconnect
                                            with
                                            yourself more fully.
                                        </div>
                                    </div>
    ...
    <section class="section-padding color-bg wellness-section">
        <div class="container">
            <div class="row ">
                <div class="col-md-6">
                    <div class="wellness-content left">
                        <h2>Ayurveda Chakra Awakening <span class="symbol-font mx-1"> &</span> Energy Reset</h2>
                        <p>5 or 7 Days</p>
                        <p>Emotional balance, chakra alignment & subtle energy healing through integrative practices
                        </p>
                            ...
                            <div class="accordion" id="accordionSpiritual">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFifteen" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            focused
                                            intention for emotional clarity and flow.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Crystal Healing + Sound Vibration Therapy
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseEighteen" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            emotional
                                            tension and enhance energetic balance.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Creative Expression Sessions (Art or Movement)</span>
                                        </button>
                                    </h2>
                                    <div id="collapseTwenty" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionSpiritual">
                                        <div class="accordion-body">
                                            Guided visual art or embodied movement to express blocked emotions and
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwentyOne" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionSpiritual">
                                        <div class="accordion-body">
                                            A sacred closing ceremony with intention setting, mantra chanting, and
                                            fire
                                            release for personal transformation.
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="well_img_box">
                        <img src="assets/wellness/Ayurveda-chakra.jpg" alt="" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding wellness-section">
        <div class="container">
            <div class="row ">
                <div class="col-md-6">
                    <div class="well_img_box">
                        <img src="assets/wellness/Panchakarma-Rejuvenation.jpg" alt="" class="w-100 object-fit-cover">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="wellness-content right">
                        ...
                        <p>7 or 10 Days</p>
                        <p>Deep cellular detox, rejuvenation, and doshic balance through individualized classical
                            Ayurvedic Panchakarma therapies.</p>
                            ...
                            <div class="accordion" id="accordionPRP">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapsePRPone" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            Ayurvedic pulse & tongue diagnosis Personalized detox plan and dietary
                                            recommendations
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapsePRPfour" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionPRP">
                                        <div class="accordion-body">
                                            Medicated herbal steam post-Abhyanga to open channels and prepare the body
                                            for detox
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapsePRPfive" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionPRP">
                                        <div class="accordion-body">
                                            Depending on the guest’s constitution and imbalance: Virechana (gentle
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapsePRPseven" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionPRP">
                                        <div class="accordion-body">
                                            Light sattvic meals (kitchari, soups, herbal teas) Digestive spice waters
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="wellness-content left">
                        ...
                        <p>5 or 7 Days</p>
                        <p>Cleanse the body, boost immunity, and revive skin and digestion with Ayurvedic methods and
                            modern self-care.</p>
                        <div class="accordion-container">
                            <div class="accordion" id="accordionADGP">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseADGPone" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            Gentle elimination practices like nasya, basti, and digestive resets adapted
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseADGPtwo" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionADGP">
                                        <div class="accordion-body">
                                            Rejuvenating facial massage using herbal oils and tools to stimulate detox
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseADGPthree" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionADGP">
                                        <div class="accordion-body">
                                            Daily movement, exfoliation, and self-massage rituals to enhance lymph flow,
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseADGPfour" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionADGP">
                                        <div class="accordion-body">
                                            Simple, warm, dosha-balancing meals and digestive herbal infusions to
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseADGPfive" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionADGP">
                                        <div class="accordion-body">
                                            Therapeutic heat therapies to encourage sweat purification, toxin release,
                                            and skin glow.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseADGPsix" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionADGP">
                                        <div class="accordion-body">
                                            Expert guidance on gut health, food combining, and daily Ayurvedic habits
                ...
                <div class="col-md-6">
                    <div class="well_img_box">
                        <img src="assets/wellness/Ayurveda-Detox.jpg" alt="" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding wellness-section">
        <div class="container">
            <div class="row ">
                <div class="col-md-6">
                    <div class="well_img_box">
                        <img src="assets/wellness/Ayurveda-Mind.jpg" alt="" class="w-100 object-fit-cover">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="wellness-content right">
                        ...
                        <p>5 or 7 Days</p>
                        <p>Reset the nervous system, release tension, and build resilience with body-based therapies and
                            education.</p>
                            ...
                            <div class="accordion" id="accordionAMBRR">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseAMBRRone" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            Gentle body-based practices and breathwork to regulate stress, release
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseAMBRRtwo" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAMBRR">
                                        <div class="accordion-body">
                                            Subtle hands-on therapy to harmonize the body’s energy flow, reset the
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseAMBRRthree" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAMBRR">
                                        <div class="accordion-body">
                                            Education on foods and herbs that support vagal tone, gut-brain health, and
                                            emotional stability.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseAMBRRfour" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAMBRR">
                                        <div class="accordion-body">
                                            Guided writing prompts to help process old wounds, reframe narratives, and
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseAMBRRfive" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAMBRR">
                                        <div class="accordion-body">
                                            Deep sensory immersion therapies that stimulate parasympathetic response and
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseAMBRRsix" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAMBRR">
                                        <div class="accordion-body">
                                            Sonic meditations using instruments like gongs, chimes, and bowls to unwind
    ...
    <section class="section-padding color-bg wellness-section">
        <div class="container">
            <div class="row ">
                            ...
                            <div class="accordion" id="accordionAESI">
                                <div class="accordion-item">
                                    ...
                                    <div id="accordionAESIone" class="accordion-collapse collapse "
                                        ...
                                        <div class="accordion-body">
                                            Begin each day with mindful walks on natural ground to discharge stress and
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="accordionAESItwo" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAESI">
                                        <div class="accordion-body">
                                            Silent, breath-led meditations among trees to enhance stillness, deepen
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="accordionAESIthree" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAESI">
                                        <div class="accordion-body">
                                            Elevated yoga experiences surrounded by nature, promoting presence, balance,
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="accordionAESIfour" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAESI">
                                        <div class="accordion-body">
                                            Full-body massage using earthy essential oils like vetiver and sandalwood to
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="accordionAESIfive" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAESI">
                                        <div class="accordion-body">
                                            Evening gatherings around fire or candlelight with ancestral stories,
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="accordionAESIsix" class="accordion-collapse collapse"
                                        data-bs-parent="#accordionAESI">
                                        <div class="accordion-body">
                                            Wholesome, locally sourced meals crafted to nourish the body and align with
                ...
                <div class="col-md-6">
                    <div class="well_img_box">
                        <img src="assets/wellness/Ayurveda-Earth.jpg" alt="" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-padding wellness-section">
        <div class="container">
            <div class="row ">
                <div class="col-md-6">
                    <div class="well_img_box">
                        <img src="assets/wellness/Add-Ons.jpg" alt="" class="w-100 object-fit-cover">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="wellness-content right">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <select name="program" id="program">
                                    ...
                                    <option value="Ayurveda Detox & Glow Program">Ayurveda Detox & Glow Program</option>
                                    <option value="Ayurveda Mind - Body Resilience Reset">Ayurveda Mind - Body
                                        Resilience Reset</option>
                                    <option value="Ayurveda Earth & Spirit Immersion">Ayurveda Earth & Spirit Immersion
                                    </option>
